...
export const cssText: any = createUseStyles({
  base: {
...
export const cssTextWeight: any = createUseStyles({
  bold: {
    fontWeight: "bold"
  },
  bolder: {
...
export const cssTextStyle: any = createUseStyles({
  italic: {
    fontStyle: "italic"
  },
  crossedOut: {
...
export const cssTextVariant: any = createUseStyles({
  headingOne: {
