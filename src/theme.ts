// theme Object Literal No CSS Variables
...
theme.branding = {
  global            : theme.color.global,
  globalContrast    : theme.color.white,
  primary           : theme.color.primary,
  primaryContrast   : theme.color.white,
  secondary         : theme.color.secondary,
  secondaryContrast : theme.color.white,
  tertiary          : theme.color.tertiary,
  tertiaryContrast  : theme.color.white,
  neutral           : theme.color.neutral,
  neutralContrast   : theme.color.black,
  warning           : theme.color.warning,
  warningContrast   : theme.color.white,
  info              : theme.color.info,
  infoContrast      : theme.color.black,
  disabled          : theme.color.disabled,
  disabledContrast  : theme.color.white,
  inactive          : theme.color.inactive,
  inactiveContrast  : theme.color.white
}
